...
app.get('/', function (req, res) {
    ...
    res.write('<div class="alert alert-info" id="info">Status: <b>RUNNING</b> <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><br>');
    ...
    PythonShell.PythonShell.run('script_web_e2L.py', options, function (err, results) {
        ...
        res.write('info.classList.remove("alert-info");');
